        ...
        <div>
            <div 
                ...
                <div className='space-y-3'>
                    <h1 className='text-5xl text-prime-blue montserrat font-extrabold'>Amaia Scapes Laguna</h1>
                    <h2 style={{letterSpacing: "1rem"}} className='text-4xl font-extrabold text-prime-green uppercase'>Property List</h2>
                </div>
            </div>
